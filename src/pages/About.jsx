        ...
        <div className={styles.history__description}>
          ...
          <div className={styles.history__list}>
            <ul>
              ...
              <li className={styles.history__list_item}>{data.aboutList10}</li>
              <li className={styles.history__list_item}>{data.aboutList11}</li>
              <li className={styles.history__list_item}>{data.aboutList12}</li>
              <li className={styles.history__list_item}>{data.aboutList13}</li>
              <li className={styles.history__list_item}>{data.aboutList14}</li>
              <li className={styles.history__list_item}>{data.aboutList15}</li>
            </ul>
          </div>
        </div>
